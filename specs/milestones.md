...
- **GitHub Release asset:** the `github-release` cell of the `publish` matrix stages `packages/cli/man/nowline.1` alongside the six platform binaries and two `.deb`s; advanced direct-download users can grab it from the same release page.
